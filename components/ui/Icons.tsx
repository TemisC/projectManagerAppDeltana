...
// Quantity Surveyor Logo: Clipboard with calculations/lines and a pen/ruler style
...
export const CollaboratorsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
